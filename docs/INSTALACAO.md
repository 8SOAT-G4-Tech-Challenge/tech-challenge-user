...
**IMPORTANTE:**
Esta API está programada para ser acessada a partir de `http://localhost:3333` e o banco de dados utiliza a porta `5433`.
Certifique-se de que não existam outros recursos ocupando as portas `3333` e `5433` antes de subir o projeto.
